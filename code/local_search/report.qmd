---
title: "Dacca Report (Local Search)"
format:
  html:
    toc: true
...
(
    ggplot(
        final_loglik.replace({"source": {"gpu": "IF2", "train": "IFAD"}}),
...
(
    ggplot(
        final_params.replace({"source": {"gpu": "IF2", "train": "IFAD"}}),
