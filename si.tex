...
Note that the bound diverges as $\alpha\uparrow1$. That singularity is caused by
separately bounding the within-window difference and the omitted tail. We will show within the next section that this can be avoided.
...
$n$th DMOP-$\alpha$ conditional-score estimate. 
