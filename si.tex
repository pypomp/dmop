...
% set theorem style to match the main text
...
\title{Supporting Materials for ``Automatic Differentiation Accelerates Inference for Partially Observed Markov Processes''}

\author{Kevin Tan$^1$, Giles Hooker$^1$ and Edward L. Ionides$^2$\\\small $^1$University of Pennsylvania and $^2$University of Michigan}
\date{}
...
Other papers testing methods on this example include \citet{ionides15,fasiolo16,wycoff24}.
