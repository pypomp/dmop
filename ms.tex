...
Here the current DMOP object consists of the
particle location and the gradient of its log weight.  The location transition
is the one in (A2), and differentiating the log-space weight recursion gives
...
\[
pG'(\theta)^2\min\{N^2,N^2/J+N^3/J^2\}.
\]
The proof conditions on the particle
...
resampling genealogy and gives
\[
