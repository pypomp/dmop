...
\vspace*{-3ex}
\begin{equation*}    \lambda_t=\exp\hspace{-1mm}\bigg(\hspace{-.5mm}\beta_{\text{trend}}(t-t_0)+\hspace{-1mm}\sum_{j=1}^{6} \beta_j s_j(t)\hspace{-1mm}\bigg)\hspace{-1mm}\frac{I}{P} + \exp\hspace{-1mm} \bigg(\sum_{j=1}^{6} \omega_j s_j(t)\hspace{-1mm}\bigg)\hspace{-1mm},
    \vspace*{-3ex}
\end{equation*}
