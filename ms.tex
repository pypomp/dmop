...
We test IFAD with $\alpha = 0, 0.97, 1$ against IF2 on a global search problem for the Dhaka cholera model using our implementation in Pypomp 0.4.6.0 \citep{abkemeier25}.
...
Our numerical results use an implementation of our methods in the Pypomp library \citep{abkemeier25}.
