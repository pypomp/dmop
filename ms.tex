...
\caption{Maximum log-likelihood found by IF2 and IFAD. IFAD-0.97 performs the best among all methods.}
\arxiv{}{\vspace*{-7mm}}
\label{table:mle}
\end{table}
...
The results of Table~\ref{table:mle}, Figure~\ref{fig:scatter} and Figure~\ref{fig:boxplot}) indicate that the actual MLE is around \eic{XXXXX}. 
...
\eic{ I GUESS AT THIS POINT WE JUST SHOW THE FULL RESULTS WITH ADAM AND COOLING.
...
\begin{figure}[ht]
    \centering
    \arxiv{}{\vspace*{0.1ex}}
    \includegraphics[width=\arxiv{10cm}{\textwidth/\real{2.2}}]{imgs/precise_raincloud.pdf}
    %\arxiv{}{\vspace*{-1mm}}
...
\begin{figure}[ht]
    \centering
    \vspace{1mm}
    \includegraphics[width=\arxiv{10cm}{\textwidth/2}]{imgs/precise_traces.pdf}
    \arxiv{}{\vspace*{-1mm}}
