...
Examining Table \ref{table:mle}, IFAD-0.97 attained a log-likelihood of -3744.36, which surpassed IF2 even when IF2 ran for 4 times as long.
...
Using the improved computational efficiency of Pypomp (elaborated upon in Section \ref{sec:efficiency}), IF2 alone surpasses all of these previous results within a wall clock time of about an hour, while IFAD-0.97 does so in under eight minutes and holds the record at $-3743.93$.
