...
Empirically, the benchmark tests suggest that IFAD is a significant methodological advance over the IF2 algorithm of \cite{ionides15} for plug-and-play statistical inference on POMP models.
